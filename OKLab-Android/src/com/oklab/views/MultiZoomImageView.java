...
public class MultiZoomImageView extends ImageView implements OnTouchListener{

	private static final String TAG = "MultiZoomImageView";
	// 디버깅 정보
    ...
    public MultiZoomImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MultiZoomImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
 
    public MultiZoomImageView(Context context) {
        this(context, null);
    }
