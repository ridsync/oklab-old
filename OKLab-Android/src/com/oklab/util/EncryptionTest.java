...
/**
 * BASE64  인코딩
 * MD5, MD2, SHA-1, SHA-256, SHA-384, SHA-512 등  단방향 암호화 : 해시함수  복호화 불가. 
 * => JAVA : MessageDigest Class
 * 
 * AES, DES, DESede, SEED , 3DES (대칭키) / RSA(비대칭키) 양방향 암호화(블럭 암호화) : 복호화 가능.
 * => JAVA : Cipher Class
 * 
...
public class EncryptionTest extends BaseActivity{
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        // 2. Encdoe SHA-1
      		String sha = EncryptionTest.encode("안녕하세요");
...
//        System.out.println(sha);
    ...
    public static String encode(String message){
        ...
        try {
            ...
            return Base64.encodeToString( md.digest(message.getBytes()), Base64.DEFAULT);
