...
public class EnterSharedElementTextSizeHandler extends SharedElementCallback {
    ...
    public void addTextViewSizeResource(View tv, int sizeBegin, int sizeEnd) {
    ...
    public void addTextView(View tv, int sizeBegin, int sizeEnd) {

        Transition textSize = new TextSizeTransition();
        textSize.addTarget(tv.getId());
        textSize.addTarget(((TextView) tv).getText().toString());
        mTransitionSet.addTransition(textSize);

        textViewList.put(((TextView)tv), new Pair<>(sizeBegin, sizeEnd));
    }
