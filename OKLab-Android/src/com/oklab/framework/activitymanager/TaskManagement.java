...
public class TaskManagement extends BaseActivity {
	private static final String TAG = TaskManagement.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		child2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent inte = new Intent(TaskManagement.this,PickMediaTestActivity.class);
